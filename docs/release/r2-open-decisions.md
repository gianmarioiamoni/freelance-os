...
R2-E05 (`docs/release/r2-e05-advanced-reporting-export.md`) is CERTIFIED. Residual #5 (R2-OD-012) and E05-D-REPORT-SCOPE / TEMPORAL-MODEL / REPORT-FILTERS are APPROVED / CLOSED. Native CSV is shipped. This register does not authorize R2 production release. R2 is not production-ready.
