...
- R2-E04 Forecasting & Contract Time Allocation P-E04-00 COMPLETE — BLOCKED — PO DECISIONS REQUIRED (`docs/release/r2-e04-forecasting-allocation.md`). No implementation, schema, or migration. Next: Product Owner close of E04-D-FORECAST-ARITHMETIC, allocation WARNING/EXCEEDED, consumption numerator/window/out-of-validity, and revenue UI surface. P-E04-01 NOT STARTED / NOT AUTHORIZED. R2 is not production-ready.
