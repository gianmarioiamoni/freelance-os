...
Planning and architecture documents are the source of truth. See [`MASTER_PLAN.md`](./MASTER_PLAN.md). R2 Revenue Operations is the active next product evolution and remains in planning (`docs/release/r2-decision-pack.md`, `docs/release/r2-epic-map.md`). No R2 implementation epic is approved. R2 is not production-ready.
