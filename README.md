...
Release 1 — MVP in progress. EPIC-101 complete: workspace-scoped client master-data management (create, list ACTIVE, archived view, detail, edit, archive). EPIC-006 authenticated UI foundation and EPIC-005 isolated E2E / CI contract remain. Authentication remains Better Auth. Contract management is not implemented. Role permissions (OBD-009) and production password-reset email are not decided. This is not production readiness.
