...
Planning and architecture documents are the source of truth. See [`MASTER_PLAN.md`](./MASTER_PLAN.md). R2 Revenue Operations is the active next product evolution. R2-E01 Revenue Visibility is COMPLETE / RELEASE-READY (`docs/release/r2-e01-revenue-visibility.md`). Next: R2-E02 Invoice Tracking. R2 is not production-ready.
