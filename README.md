...
Planning and architecture documents are the source of truth. See [`MASTER_PLAN.md`](./MASTER_PLAN.md). R2 discovery is closed (`docs/release/r2-decision-pack.md`). No R2 implementation epic is approved.
